...
function explainGame() {
    alert(
        ...
        "1️⃣ You have a 3x3 grid.\n" +
        "2️⃣ Each row, column, and diagonal should sum up to the same number.\n" +
        "3️⃣ Click a cell and enter a number in the input box.\n" +
        "4️⃣ Use Shuffle to mix numbers, Reset to clear, and Check to see if it's correct.\n\n" +
        "💡 Tip: Pay attention to each row, column, and diagonal sum to make it a Magic Square!"
    );
}

// 10️⃣ ربط زر Explain بوظيفة الشرح
